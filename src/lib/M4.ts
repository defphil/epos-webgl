export class M4 {
    ...
    public static projectPerspective(fovRads: number, aspect: number, near: number, far: number): number[] {
    ...
    public static translate(m: number[], tx: number, ty:number, tz:number):number [] {
    ...
    public static substractVec(a: number[], b:number[]):number[] {
        return [a[0] - b[0], a[1] - b[1], a[2] - b[2]];
    }

    public static normalizeVec(a: number[]):number[] {
